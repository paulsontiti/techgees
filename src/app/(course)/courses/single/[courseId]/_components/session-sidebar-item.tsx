  ...
  return (
    <div className=" mt-1">
      <button
        ...
        type="button"
        className={cn(
          "bg-slate-300/20 w-full h-[50px] flex items-center gap-x-2 text-slate-500 text-sm font-[500] pl-2 transition-all hover:text-slate-600 hover:bg-slate-300/20",
          isActive &&
