...
import { Category, Course, ScholarshipStudents } from "@prisma/client";
...
import { ScholarshipDetailsDialog } from "./scholarship-details-dialog";
import ShareButton from "@/components/share-button";

type ScholarshipCourseCardProps = {
...
function ScholarshipCourseCard({
  ...
  return (
      ...
      className="
        ...
        "
    >
      <ShareButton fBHashtag="#theglobalgenius_scholarship" url={`${url}scholarships`} />
