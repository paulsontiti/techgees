...
type SessionType = {
  ...
  courseId:string,
  projectId:string,
  sessions:ChapterProjectSession[]
}
function ChapterProjectSessionForm({ chapterId,sessions,courseId,projectId }: SessionType) {
  ...
  const onSubmit = async (values: zod.infer<typeof formSchema>) => {
    try {
      await axios.post(`/api/courses/${courseId}/chapters/${chapterId}/projects/${projectId}/sessions`, values);
  ...
  const onEdit = (sessionId:string)=>{
    router.push(`/teacher/courses/${courseId}/chapters/${chapterId}/projects/${projectId}/sessions/${sessionId}`)
  }
              ...
              render={({ field }) => {
                return (
                  <FormItem>
                    ...
                    <FormDescription>
                      {`What's the title of the session`}
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                );
...
export default ChapterProjectSessionForm;
