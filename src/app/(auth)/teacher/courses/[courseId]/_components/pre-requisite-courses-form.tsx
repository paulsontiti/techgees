...
function PreRequisiteCoursesForm(
  {preRequisiteCourses,courses,courseId}:
  {preRequisiteCourses:Course[],courses:Course[],courseId:string}) {
const [editing,setEditing] = useState(false)
const router = useRouter()

const [open, setOpen] = React.useState(false)
const [loading, setLoading] = React.useState(false)
const [selectedCourses,setSelectedCourses] = useState<Course[]>(preRequisiteCourses)
    ...
    <div>
       ...
       :
         <div className={cn('text-sm mt-2',
            preRequisiteCourses.length === 0 && "text-slate-500 italic"
         )}>{preRequisiteCourses.length > 0 ? <div className="flex gap-2 flex-wrap">
...
export default PreRequisiteCoursesForm