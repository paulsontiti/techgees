...
function CourseAssignmentForm({ courseId,assignments }:
  { courseId:string,assignments: Assignment[] } ) {
...
Course Benefits
      ...
      {!isCreating && (
        <div>
          <div className={cn(
            "text-sm mt-2",
            Array.isArray(assignments) && assignments.length === 0 && "text-slate-500 italic"
          )}>{ Array.isArray(assignments) && assignments.length === 0 && "No text"}
