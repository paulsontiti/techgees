...
function TitleForm({challenge}:{challenge:Challenge}) {
...
render={({field})=>{
    return   <FormItem>
          ...
          <FormDescription>{`What's the name of the challenge`}</FormDescription>
          <FormMessage/>
      </FormItem>
  }}
/>
<div className='flex items-center gap-x-2'>
        ...
        </Form> : <p className='text-sm mt-2'>{challenge.title}</p>}
    </div>
  )
}
