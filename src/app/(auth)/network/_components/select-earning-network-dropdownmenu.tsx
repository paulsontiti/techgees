...
export function SelectEarningNetworkDropdownMenu({selectedValue,setSelectedValue}:
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="">
        ...
        <DropdownMenuRadioGroup value={selectedValue} onValueChange={setSelectedValue}>
            <DropdownMenuRadioItem value="Monthly Earnings" >
                Monthly Earnings</DropdownMenuRadioItem>
                <DropdownMenuRadioItem value="Network Growth" >
                Network Growth</DropdownMenuRadioItem>
        </DropdownMenuRadioGroup>
      </DropdownMenuContent>
    </DropdownMenu>
  )
