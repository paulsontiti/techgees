...
export function EarningsTable<TData, TValue>({
  columns,
  ...
  React.useEffect(()=>{
    (
        async()=>{
            try{
                const res = await axios.get("/api/user/earnings/all");
                setData(res.data);
            }catch(err:any){
  ...
  return (
   <section className="p-4 bg-white w-full lg:max-w-[730px] xl:max-w-[1000px] overflow-scroll">
     <div className={`${textPrimaryColor} mb-4 text-xl`}>Recent Earnings</div>
