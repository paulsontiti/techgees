...
const {screenWidth} = useScreenWidth();
  ...
  return (
    <>
        <Card className={`md:flex flex-col hidden items-center justify-center md:w-[300px]` }>
        <CardHeader>
    ...
    <Card className={`flex flex-col md:hidden items-center justify-center md:w-[300px]` } style={{width:screenWidth}}>
        <CardHeader>
        <div className={`w-8 h-8 rounded-full ${bgPrimaryColor} text-white flex items-center justify-center`}>
            {num}
        </div>
