...
const WhyUsCards  = [
  {num:'1', title:'Self-paced', description:<TestimonialText>
    <div>{` Self-paced online learning offers numerous benefits, especially for individuals juggling multiple commitments or looking to gain specific skills at their convenience.`}
  ...
  {num:'2', title:'Personal Coaching & Mentorship', description:<TestimonialText>
    <div>
 ...
 {num:'3', title:'3 months internship', description:<TestimonialText>
  <div>
...
{num:'4', title:'Flexible Installment Payment Plan', description:<TestimonialText>
  <div>
    <p>
