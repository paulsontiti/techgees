...
categories
    ...
    return (
        <section className=" bg-sky-900 my-4 py-4 px-2 sm:flex flex-col items-center justify-center hidden md:hidden">
...
export default SMPopularCourses;
