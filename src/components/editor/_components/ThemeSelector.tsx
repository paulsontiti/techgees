  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <motion.button
        ...
        className="w-40 group relative flex items-center gap-1 px-2 py-2.5 bg-[#1e1e2e]/80 hover:bg-[#262637] 
      ...
      >
        ...
        <Palette className="w-4 h-4 mr-1 text-gray-400 group-hover:text-gray-300 transition-colors" />
